...
message(STATUS "=== Set language bindings to ${HDF5_LANGUAGE_BINDINGS}")
...
if( NOT HDF5_FOUND )
    message(STATUS "=== Doing a QUIET search with NO_MODULE")
    ...
    if( HDF5_FOUND )
        ...
        message(STATUS "=== Not found in QUIET search with NO_MODULE")
    endif()
endif()
...
if( NOT HDF5_FOUND )
    ...
    set( HDF5_Fortran_HL_LIBRARY_NAMES_INIT hdf5hl_fortran ${HDF5_Fortran_LIBRARY_NAMES_INIT} )
    set( HDF5_TOOLS_LIBRARY_NAMES_INIT      hdf5_tools ${HDF5_C_LIBRARY_NAMES_INIT} )
    
    message(STATUS "=== Processing bindings ${HDF5_LANGUAGE_BINDINGS}" )
    foreach( LANGUAGE ${HDF5_LANGUAGE_BINDINGS} )
        ...
        foreach( LIB ${HDF5_${LANGUAGE}_LIBRARY_NAMES} )
            if( UNIX AND HDF5_USE_STATIC_LIBRARIES )
                ...
                set( THIS_LIBRARY_SEARCH_DEBUG lib${LIB}d.a ${LIB}d ${LIB}_D)
                set( THIS_LIBRARY_SEARCH_RELEASE lib${LIB}.a ${LIB} )
            else()
                set( THIS_LIBRARY_SEARCH_DEBUG lib${LIB}_D ${LIB}_D ${LIB}d)
                set( THIS_LIBRARY_SEARCH_RELEASE lib${LIB} ${LIB} )
            endif()
            message(STATUS "=== Finding dbg ${THIS_LIBRARY_SEARCH_DEBUG} rel  ${THIS_LIBRARY_SEARCH_RELEASE}")
    ...
    if (HDF5_LIBRARIES)
        message(STATUS "=== Found libraries ${HDF5_LIBRARIES}")
    else ()
        message(STATUS "=== NO libraries found!")
    endif ()
