// bmp_io.cpp
// from : http://people.sc.fsu.edu/~jburkardt/cpp_src/bmp_io/bmp_io.html
...
static bool bmp_byte_swap = false;
...
///////////////////////////////////////////////////////////////////////////////
// The following items were added by me, Geoff R. McLane, 5 March, 2014
// I was on a quest to find some 'simple' way to render certain geographic
// data as an image. I ended up NOT using any of this.
///////////////////////////////////////////////////////////////////////////////
...
int main( int argc, char **argv )
{
    ...
    printf("This application does NOTHING!\n");
    printf("It is just some crossplatform Windows BMP functions.\n");
    printf("This the full list from bmp_io.hpp\n\n");
    printf(function_list);
    printf("Although the file has a C++ extension, there is not really anything\n");
    printf("that is really C++. Most, if not all functions could be extracted and\n");
    printf("quite easily be used in a C program.\n\n");
    printf("The source is from : http://people.sc.fsu.edu/~jburkardt/cpp_src/bmp_io/bmp_io.html\n");
    printf("The Licensing: This code is distributed under the GNU LGPL license. \n");
    printf("Asside from this main() added by me, it was last modified: 13 August 2007, with an\n");
    printf("earliest date of 26 February 2003\n");
    printf("The original Author: John Burkardt, and my thanks to him for putting them together.\n");
    printf("Of course it could be quite easily cast into a library to attach to your own app.\n");
    printf("The important thing is that it is quite crossplatform, having NO dependency on the\n");
    printf("windows GDI header files.\n");
    return iret;
}
